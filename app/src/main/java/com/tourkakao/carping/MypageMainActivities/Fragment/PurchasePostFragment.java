...
public class PurchasePostFragment extends Fragment {
    ...
    void initLayout(){
        binding.mypageEmptyText.setText("구매한 포스트가 없습니다.");
        mLayoutManager = new LinearLayoutManager(getActivity());
        binding.mypageRecycler.setLayoutManager(mLayoutManager);
    }
    void observeData(){
        viewModel.getPurchase().observe(this, new Observer<ArrayList<Post>>() {
            @Override
