...
public class MySharingFragment extends Fragment {
    ...
    void initLayout(){
        binding.mypageEmptyText.setText("무료나눔 내역이 없습니다.");
        mLayoutManager = new LinearLayoutManager(getActivity());
        binding.mypageRecycler.setLayoutManager(mLayoutManager);
        binding.mypageRecycler.setAdapter(viewModel.settingMyAdapter());
    }

    void observeData(){
        viewModel.getMyShare().observe(this, new Observer<ArrayList<Share>>() {
            @Override
